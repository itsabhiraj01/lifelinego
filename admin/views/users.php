	        ...
	        <?php 
	            ...
	            while($list = mysqli_fetch_assoc($r)) { 
	              ...
	              <a class="list-group-item <?php selected($list['id'], $opened['id'], 'active') ?>" href="index.php?page=users&id=<?php echo $list['id']?>">
	                  ...
	                  <!-- <p class="list-group-ietm-text"><?php //echo $blurb; ?></p> -->
	              </a>
	...
	<div class="col-md-9">
	    ...
	    <form role="form" method="POST" action="index.php?page=users&id=<?php echo $opened['id']; ?>">
	        ...
	        <div class="form-group">
	            ...
	            <input class="form-control" type="password" name="passwordr" id="passwordr" value="" placeholder="Retype Password" autocomplete="off">
